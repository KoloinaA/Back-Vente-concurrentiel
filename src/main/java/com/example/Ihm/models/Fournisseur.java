...
public class Fournisseur {
    ...
    public Fournisseur(int idFr, String nomFr, String mdpFr, String mailFr, com.mysql.cj.jdbc.Blob imgFr, String contactFr, String adresseFr, Boolean accesFr) {
        this.idFr = idFr;
        this.nomFr = nomFr;
        this.mdpFr = mdpFr;
        this.mailFr = mailFr;
    ...
    public Fournisseur(String nomFr, String mdpFr, String mailFr, com.mysql.cj.jdbc.Blob imgFr, String contactFr, String adresseFr, Boolean accesFr) {
        this.nomFr = nomFr;
        this.mdpFr = mdpFr;
        this.mailFr = mailFr;
        this.imgFr = imgFr;
    ...
    public Blob getImgFr() {
        return imgFr;
    }

    public void setImgFr(com.mysql.cj.jdbc.Blob imgFr) {
        this.imgFr = imgFr;
    }
